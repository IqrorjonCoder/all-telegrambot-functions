...
def runner():
    ...
    # dispatcher.add_handler(MessageHandler(Filters.audio, answer_inline_query))
    # dispatcher.add_handler(MessageHandler(Filters.document, answer_inline_query))
    # dispatcher.add_handler(MessageHandler(Filters.animation, answer_inline_query))
    # dispatcher.add_handler(MessageHandler(Filters.photo, answer_inline_query))
    # dispatcher.add_handler(MessageHandler(Filters.sticker, answer_inline_query))
    # dispatcher.add_handler(MessageHandler(Filters.video, answer_inline_query))
    # dispatcher.add_handler(MessageHandler(Filters.voice, answer_inline_query))
