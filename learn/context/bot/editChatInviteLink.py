...
def editChatInviteLink(update, context):
    ...
    x = context.bot.editChatInviteLink(chat_id=update.effective_chat.id,
...
def runner():
    ...
    dispatcher.add_handler(CommandHandler('start', editChatInviteLink))
