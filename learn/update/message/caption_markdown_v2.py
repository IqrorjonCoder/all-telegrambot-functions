...
def caption_markdown_v2(update, context):
    print(update.message.caption_markdown_v2)
    update.message.reply_text(f"caption markdown v2 : \n{update.message.caption_markdown_v2}")
...
def runner():
    ...
    dispatcher.add_handler(MessageHandler(Filters.animation, caption_markdown_v2))
